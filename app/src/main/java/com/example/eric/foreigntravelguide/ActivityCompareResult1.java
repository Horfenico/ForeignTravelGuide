...
public class ActivityCompareResult1 extends ActivityCompare implements TabHost.OnTabChangeListener {
    ...
    private void initialiseTabHost(Bundle args) {
        ...
        ActivityCompareResult1.addTab(this, this.mTabHost, this.mTabHost.newTabSpec("Advisery").setIndicator("Advisery"), (tabInfo = new TabInfo("Advisery", FragmentTab1.class, args)));
        this.mapTabInfo.put(tabInfo.tag, tabInfo);
        ActivityCompareResult1.addTab(this, this.mTabHost, this.mTabHost.newTabSpec("Laws").setIndicator("Laws"), (tabInfo = new TabInfo("Laws", FragmentTab2.class, args)));
        this.mapTabInfo.put(tabInfo.tag, tabInfo);
